...
set HDF_DIR ./hdf
set HDF_FILE noddr-0-uart-elsegpio.hdf
...
set_property -dict [list CONFIG.PCW_UART0_PERIPHERAL_ENABLE {1} CONFIG.PCW_UART0_UART0_IO {MIO 10 .. 11} CONFIG.PCW_UART0_BAUD_RATE {115200}] [get_bd_cells processing_system7_0]
...
set_property -dict [list CONFIG.PCW_GPIO_EMIO_GPIO_ENABLE {1}] [get_bd_cells processing_system7_0]


# other options
# set_property -dict [list CONFIG.PCW_MIO_10_PULLUP {disabled} CONFIG.PCW_MIO_11_PULLUP {disabled}] [get_bd_cells processing_system7_0]
#set_property -dict [list CONFIG.PCW_MIO_10_SLEW {fast} CONFIG.PCW_MIO_11_SLEW {fast}] [get_bd_cells processing_system7_0]
