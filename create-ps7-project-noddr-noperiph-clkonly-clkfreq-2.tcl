...
set HDF_DIR ./hdf
set HDF_FILE noddr-0-clkfreq-2.hdf
...
set_property -dict [list CONFIG.PCW_CRYSTAL_PERIPHERAL_FREQMHZ {60} CONFIG.PCW_APU_PERIPHERAL_FREQMHZ {620} CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {20} CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {30} CONFIG.PCW_FPGA2_PERIPHERAL_FREQMHZ {40} CONFIG.PCW_FPGA3_PERIPHERAL_FREQMHZ {50}] [get_bd_cells processing_system7_0]
