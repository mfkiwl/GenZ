...
set HDF_DIR ./hdf
set HDF_FILE noddr-0-bankvolt.hdf
...
# HSTL 1.8V
set_property -dict [list CONFIG.PCW_PRESET_BANK0_VOLTAGE {LVCMOS 1.8V} CONFIG.PCW_PRESET_BANK1_VOLTAGE {LVCMOS 2.5V}] [get_bd_cells processing_system7_0]
