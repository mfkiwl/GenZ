...
set HDF_DIR ./hdf
set HDF_FILE noddr-0-sd-emio.hdf
...
set_property -dict [list CONFIG.PCW_SD0_PERIPHERAL_ENABLE {1} CONFIG.PCW_SD0_SD0_IO {EMIO}] [get_bd_cells processing_system7_0]
